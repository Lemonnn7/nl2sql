...
智能问答系统 is open-source and extensible. If you'd like to use Vanna without the servers, see an example [here](/docs/local.html).
...
class VannaBase(ABC):
    ...
    def generate_followup_questions(
        ...
        **Example:**
        ...
        Generate a list of followup questions that you can ask 智能问答系统.
        ...
        Returns:
            list: A list of followup questions that you can ask 智能问答系统.
        """
    ...
    def generate_questions(self, **kwargs) -> List[str]:
        ...
        **Example:**
        ...
        Generate a list of questions that you can ask 智能问答系统.
        """
    ...
    def ask(
        ...
        **Example:**
        ...
        Ask 智能问答系统 a question and get the SQL query that answers it.

        Args:
            question (str): The question to ask.
            print_results (bool): Whether to print the results of the SQL query.
            auto_train (bool): Whether to automatically train 智能问答系统 on the question and SQL query.
    ...
    def train(
        ...
        **Example:**
        ...
        Train 智能问答系统 on a question and its corresponding SQL query.
